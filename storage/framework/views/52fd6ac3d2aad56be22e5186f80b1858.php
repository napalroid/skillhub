    ...
    <div class="grid lg:grid-cols-[380px_1fr] gap-6">
        ...
        <div class="space-y-4">
            <div class="payment-card">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->service->thumbnail): ?>
                    <img src="<?php echo e(Storage::url($order->service->thumbnail)); ?>" alt="<?php echo e($order->service->title); ?>" class="w-full h-48 object-cover mb-4 border border-gray-200">
                <?php else: ?>
                ...
                <h3 class="text-base font-bold mb-4"><?php echo e($order->service->title); ?></h3>
                
                <div class="space-y-2 text-xs pb-4 border-b border-gray-200">
                    <div class="flex justify-between">
                        <span class="text-gray-500">Penjual</span>
                        <span class="font-bold"><?php echo e($order->service->seller->name); ?></span>
                    </div>
                    <div class="flex justify-between">
                ...
                <div class="pt-4">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="font-heading text-xl font-black">Rp<?php echo e(number_format($order->final_price, 0, ',', '.')); ?></span>
                    </div>
                </div>
            </div>
            
            <a href="<?php echo e(route('orders.show', $order)); ?>" class="btn-outline w-full block text-center">
                Kembali ke Pesanan
            </a>
        </div>
        ...
        <div class="payment-card">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->payment?->qris_url && $order->payment->status === 'pending'): ?>
                <div class="qris-container text-center">
                    <img src="<?php echo e($order->payment->qris_url); ?>" alt="QRIS Midtrans" class="mx-auto w-full max-w-[280px] bg-white p-4">
                    <p class="mt-4 text-xs font-bold uppercase tracking-wider">Scan QRIS menggunakan aplikasi pembayaran yang mendukung QRIS</p>
                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->payment->expires_at): ?>
                        <p class="mt-2 text-xs text-gray-600">Berlaku hingga: <?php echo e($order->payment->expires_at->format('d M Y, H:i')); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! config('midtrans.is_production')): ?>
                    <div class="mt-6 p-4 bg-[#EDE734] border-2 border-black">
                        ...
                        <div class="flex flex-col gap-2">
                            <button type="button" id="copy-qris-url" data-qris-url="<?php echo e($order->payment->qris_url); ?>" class="btn-outline w-full">
                                Salin URL QRIS
                            </button>
                        ...
                        <button type="button" id="check-status" data-url="<?php echo e(route('orders.payment.check', $order)); ?>" class="mt-4 btn-success w-full">
            ...
            <?php elseif($order->payment_status === 'paid'): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->id() === $order->buyer_id): ?>
                    <form method="POST" action="<?php echo e(route('order-messages.store', $order)); ?>" class="mt-6 p-4 bg-gray-50 border border-gray-200">
                        <?php echo csrf_field(); ?>
            ...
            <?php elseif(auth()->id() === $order->buyer_id): ?>
                <div class="text-center py-8">
                    ...
                    <form method="POST" action="<?php echo e(route('orders.payment.qris', $order)); ?>">
                        <?php echo csrf_field(); ?>
            ...
            <div class="mt-6 p-4 bg-gray-50 border border-gray-200">
                ...
                <ol class="text-xs space-y-2 text-gray-700">
                    ...
                    <li class="flex gap-2">
                        ...
                        <span>Konfirmasi pembayaran sejumlah Rp<?php echo e(number_format($order->final_price, 0, ',', '.')); ?></span>
                    </li>
                    <li class="flex gap-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\UKK MODE SERIUS\skillhub\resources\views/payments/qris.blade.php ENDPATH**/ ?>