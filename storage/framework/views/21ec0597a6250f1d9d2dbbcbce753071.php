...
<footer class="site-footer">
        ...
        <div class="sf-container">
            ...
            <section class="sf-hero" aria-label="Footer header">
                <div class="sf-hero-content">
                    ...
                    <a href="<?php echo e(route('services.index')); ?>" class="sf-hero-cta">
                        Jelajahi Jasa
    ...
    <section class="sf-scarface-section">
        <div class="sf-scarface-wrapper">
            <img 
                src="<?php echo e($skillhubscarfaceUrl); ?>" 
...
<?php /**PATH D:\xampp\htdocs\UKK MODE SERIUS\skillhub\resources\views/components/site-footer.blade.php ENDPATH**/ ?>