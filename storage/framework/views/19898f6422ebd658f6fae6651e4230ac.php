...
<div class="relative min-h-screen" style="background: linear-gradient(135deg, #f5f5f5 0%, #ffffff 50%, #fafafa 100%);">
    ...
    <div class="max-w-[1280px] mx-auto px-4 lg:px-8 pt-12 pb-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12">
            <div class="bg-white border border-gray-300 shadow-sm p-5 border-l-4 border-l-black hover:shadow-md transition-shadow duration-200" style="border-radius: 8px;">
                ...
                <div class="text-3xl font-black text-black" style="font-family: 'Montserrat', sans-serif;"><?php echo e($services->total()); ?></div>
            </div>
            <div class="bg-white border border-gray-300 shadow-sm p-5 border-l-4 hover:shadow-md transition-shadow duration-200" style="border-radius: 8px; border-left-color: #E4002B;">
                ...
                <div class="text-3xl font-black" style="font-family: 'Montserrat', sans-serif; color: #E4002B;"><?php echo e($services->total()); ?></div>
            </div>
            <div class="bg-white border border-gray-300 shadow-sm p-5 border-l-4 hover:shadow-md transition-shadow duration-200" style="border-radius: 8px; border-left-color: #2C9F45;">
                ...
                <div class="text-3xl font-black" style="font-family: 'Montserrat', sans-serif; color: #2C9F45;"><?php echo e($services->total()); ?></div>
            </div>
    ...
    <div class="max-w-[1280px] mx-auto px-4 lg:px-8 mb-12">
        <form method="GET" action="<?php echo e(route('services.my')); ?>" id="filterForm" class="bg-white border-2 border-black shadow-sm p-6 hover:-translate-y-0.5 hover:shadow-md transition-all duration-200" style="border-radius: 8px;">
            <div class="grid md:grid-cols-12 gap-4 items-end">
                ...
                <div class="md:col-span-4">
                    ...
                    <select name="subcategory" id="filterSubcategory" class="w-full px-4 py-3 bg-white border border-gray-300 focus:outline-none focus:border-black focus:ring-2 focus:ring-black/10 transition-all text-sm" style="border-radius: 4px;">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <option value="<?php echo e($sub->id); ?>" data-category="<?php echo e($sub->category_id); ?>" <?php echo e(request('subcategory') == $sub->id ? 'selected' : ''); ?>>
                                <?php echo e($sub->name); ?>
                ...
                <div class="md:col-span-4 flex gap-3">
                    ...
                    <a href="<?php echo e(route('services.my')); ?>" class="flex-1 text-center bg-transparent text-black font-bold text-xs uppercase tracking-wider px-6 py-3 border-2 border-black hover:bg-black hover:text-white transition-all duration-150" style="font-family: 'Montserrat', sans-serif; border-radius: 4px; letter-spacing: 0.08em;">Reset</a>
                </div>
            </div>
        </form>
    </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($services->count() > 0): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="servicesGrid">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="service-card group" data-index="<?php echo e($index); ?>" style="animation: slideUp 0.4s cubic-bezier(0.16, 1, 0.3, 1) forwards; animation-delay: <?php echo e($index * 0.05); ?>s; opacity: 0;">
                            ...
                            <div class="p-5 flex-1 flex flex-col">
                                ...
                                <div class="flex items-center gap-2 mb-3">
                                    <span class="text-xs font-bold uppercase tracking-widest text-gray-400" style="font-family: 'Montserrat', sans-serif; letter-spacing: 0.08em;">
                                        <?php echo e($service->subcategory->category->name ?? 'N/A'); ?>
                                    ...
                                    <div class="flex items-end justify-between mb-4">
                                        <div>
                                            ...
                                            <div class="text-2xl font-black text-black" style="font-family: 'Montserrat', sans-serif;">
                                                <?php echo e(number_format($service->price / 1000, 0)); ?><span class="text-base">K</span>
                                            </div>
                                        </div>
