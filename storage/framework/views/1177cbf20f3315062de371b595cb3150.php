...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($toastTitle): ?>
    <div id="nf-toast-root" class="nf-toast-root">
        <div class="nf-toast">
            ...
            <div class="nf-toast-body">
                ...
                <p class="nf-toast-msg"><?php echo $toastMessage; ?></p>
            </div>
...
<?php /**PATH D:\xampp\htdocs\UKK MODE SERIUS\skillhub\resources\views/components/notification-toast.blade.php ENDPATH**/ ?>