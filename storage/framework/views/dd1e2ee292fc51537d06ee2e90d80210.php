...
<head>
    ...
    <title><?php echo e($pageTitle); ?> — SkillHub</title>
    ...
    <div class="min-h-screen flex flex-col lg:flex-row">
        ...
        <div class="hidden lg:flex lg:w-[48%] xl:w-[52%] relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center p-10 xl:p-14 w-full h-full">
                ...
                <div class="max-w-md">
                    <h2 class="font-heading text-3xl xl:text-4xl font-bold text-white leading-tight"><?php echo e($panelTitle); ?></h2>
                    <p class="mt-4 text-blue-100 leading-relaxed"><?php echo e($panelDescription); ?></p>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($variant === 'login'): ?>
                        <div class="mt-8 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-5">
                            ...
                            <div class="flex gap-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['Bayar', 'Escrow', 'Kerja', 'Selesai']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div class="flex-1">
                                        <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['h-1.5 rounded-full', 'bg-white' => $i <= 1, 'bg-white/25' => $i > 1]); ?>"></div>
                                        <p class="<?php echo \Illuminate\Support\Arr::toCssClasses(['text-[10px] mt-1', 'text-white' => $i <= 1, 'text-blue-300/60' => $i > 1]); ?>"><?php echo e($step); ?></p>
                                    </div>
                    ...
                    <?php elseif($variant === 'register'): ?>
                        <ul class="mt-8 space-y-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['Ajukan jasa ke marketplace sekolah', 'Negosiasi harga sebelum transaksi', 'Pembayaran escrow via admin', 'Review setelah pekerjaan selesai']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <p class="text-xs text-blue-200/70">&copy; <?php echo e(date('Y')); ?> Proyek UKK PPLG</p>
            </div>
        </div>
        ...
        <div class="flex-1 flex flex-col min-h-screen">
            ...
            <div class="lg:hidden relative h-44 sm:h-52 overflow-hidden shrink-0">
                <img src="<?php echo e($bgImage); ?>" alt="" class="absolute inset-0 h-full w-full object-cover">
                <div class="absolute inset-0 bg-blue-900/70"></div>
                <div class="relative z-10 h-full flex flex-col justify-center p-6">
                    <p class="font-heading text-lg font-bold text-white leading-snug max-w-xs"><?php echo e($panelTitle); ?></p>
                </div>
            </div>
            ...
            <div class="flex-1 flex items-center justify-center px-4 sm:px-8 py-8 lg:py-12 bg-slate-50 lg:bg-white">
                <div class="w-full max-w-md">
                    <div class="mb-8 flex justify-start">
                        <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 text-sm font-medium text-slate-600 hover:text-blue-600 hover:underline transition-all">
                    ...
                    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 sm:p-8">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($title): ?>
                            <h1 class="font-heading text-2xl font-bold text-slate-900"><?php echo e($title); ?></h1>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subtitle): ?>
                            <p class="text-sm text-slate-500 mt-1.5 mb-6"><?php echo e($subtitle); ?></p>
                        <?php else: ?>
                            <div class="mb-6"></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH D:\xampp\htdocs\UKK MODE SERIUS\skillhub\resources\views/layouts/guest.blade.php ENDPATH**/ ?>