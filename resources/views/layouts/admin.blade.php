            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-8">
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2 shrink-0" aria-label="SkillHub Admin Home">
                        <span class="font-heading font-bold text-base uppercase tracking-wide">SkillHub</span>
                    </a>
                    ...
                    <nav class="flex items-center gap-2" aria-label="Navigasi utama admin">
                        <template x-for="item in navItems" :key="item.route">
                            <a 
                                :href="item.route" 
                                :class="['nav-link-top', 'px-4', 'py-2.5', 'rounded-sm', 'text-sm', 'font-bold', 'uppercase', 'tracking-wide', 'transition-colors', 'duration-150',
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('dashboard') }}" class="px-4 py-2.5 text-sm font-bold uppercase tracking-wide text-white/70 hover:text-white hover:bg-white/10 rounded-sm transition-colors duration-150">Dashboard User</a>
                    ...
                    <div class="relative" x-data="{ userMenuOpen: false }">
                        <button 
                            ...
                            class="flex items-center gap-2 px-3 py-2.5 rounded-sm hover:bg-white/10 transition-colors duration-150"
